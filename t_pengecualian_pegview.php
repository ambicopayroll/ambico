...
ft_pengecualian_pegview.Lists["x_tipe"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_pengecualian_pegview.Lists["x_tipe"].Options = <?php echo json_encode($t_pengecualian_peg->tipe->Options()) ?>;
...
<?php if ($t_pengecualian_peg->tipe->Visible) { // tipe ?>
	<tr id="r_tipe">
		<td><span id="elh_t_pengecualian_peg_tipe"><?php echo $t_pengecualian_peg->tipe->FldCaption() ?></span></td>
...
<?php echo $t_pengecualian_peg->tipe->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
