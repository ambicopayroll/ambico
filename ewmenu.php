...
$RootMenu->AddMenuItem(10420, "mi_slip_bln__php", $Language->MenuPhrase("10420", "MenuText"), "slip_bln_.php", 10077, "", AllowListMenu('{9712DCF3-D9FD-406D-93E5-FEA5020667C8}slip_bln_.php'), FALSE, TRUE);
